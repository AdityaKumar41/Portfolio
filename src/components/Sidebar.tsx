      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            exit={{ x: -200 }}
            className="px-6  z-[100] py-10 bg-neutral-100 dark:bg-black max-w-[14rem] lg:w-fit  fixed lg:relative  h-screen left-0 flex flex-col justify-between"
          >
      ...
      {navlinks.map((link: Navlink) => (
        <Link
          ...
          className={twMerge(
            ...
            isActive(link.href) &&
              "bg-white  dark:bg-[#212121] shadow-lg text-primary"
          )}
        >
          <link.icon
            className={twMerge(
  ...
  return (
    <div className="flex space-x-2">
      ...
      <div className="flex text-sm flex-col">
        <p className="font-bold text-primary">Aditya</p>
